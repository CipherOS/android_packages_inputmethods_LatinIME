...
package com.cipheros.inputmethod.latin.inputlogic;
...
import com.cipheros.inputmethod.compat.SuggestionSpanUtils;
...
import com.cipheros.inputmethod.latin.Dictionary;
import com.cipheros.inputmethod.latin.DictionaryFacilitator;
import com.cipheros.inputmethod.latin.LastComposedWord;
import com.cipheros.inputmethod.latin.LatinIME;
import com.cipheros.inputmethod.latin.NgramContext;
import com.cipheros.inputmethod.latin.RichInputConnection;
import com.cipheros.inputmethod.latin.Suggest;
...
import com.cipheros.inputmethod.latin.WordComposer;
import com.cipheros.inputmethod.latin.common.Constants;
import com.cipheros.inputmethod.latin.common.InputPointers;
import com.cipheros.inputmethod.latin.common.StringUtils;
import com.cipheros.inputmethod.latin.define.DebugFlags;
import com.cipheros.inputmethod.latin.settings.SettingsValues;
import com.cipheros.inputmethod.latin.settings.SettingsValuesForSuggestion;
import com.cipheros.inputmethod.latin.settings.SpacingAndPunctuations;
import com.cipheros.inputmethod.latin.suggestions.SuggestionStripViewAccessor;
import com.cipheros.inputmethod.latin.utils.AsyncResultHolder;
import com.cipheros.inputmethod.latin.utils.InputTypeUtils;
import com.cipheros.inputmethod.latin.utils.RecapitalizeStatus;
import com.cipheros.inputmethod.latin.utils.StatsUtils;
import com.cipheros.inputmethod.latin.utils.TextRange;
...
public final class InputLogic {
     ...
     *     {@link com.cipheros.inputmethod.keyboard.KeyboardSwitcher#getKeyboardShiftMode()}
     * @return the complete transaction object
     */
    ...
    /**
     * Make a {@link com.cipheros.inputmethod.latin.SuggestedWords} object containing a typed word
     * and obsolete suggestions.
     * See {@link com.cipheros.inputmethod.latin.SuggestedWords#getTypedWordAndPreviousSuggestions(
     *      SuggestedWordInfo, com.cipheros.inputmethod.latin.SuggestedWords)}.
